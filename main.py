...
def create_population(arr, population_size, blocked_coordinates=None):
    population = []
...
def child_mutation(arr, blocked_coordinates=None):
    index1 = 0
    index2 = 0
...
def run_evolution(arr, population_size, stall, blocked_coordinates=None):
    population = create_population(arr, population_size, blocked_coordinates)
    achieve_fit = 0
    flag = 0
    generation = 0

    while True:
        population = sorted(population, key=lambda arr: fitness_func(arr))
        print(f"{generation} - {(1/fitness_func(population[0]))}")
...
#     [585545, 672185]
# ]
# blocked_coordinates=blocked_coords
generation, population = run_evolution(array, 100, 25)
print("max value")
print(f"{generation} - {(1/fitness_func(population[0]))} ")
map(population[0])
